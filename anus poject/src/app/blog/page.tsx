    ...
    <>
      ...
      <div>
        ...
        <div className="py-16 ml-8 lg:ml-36 space-y-2">
          <h1 className="text-3xl lg:text-4xl font-bold text-[#001F54]">Blog</h1> {/* Dark blue */}
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2">
                {[{ id: 4, image: "/images/blog4m.png", title: "Recent Blog 1", date: "December 6, 2024" },
                  ...
                  { id: 6, image: "/images/blog6m.png", title: "Recent Blog 3", date: "December 4, 2024" }].map((blog) => (
