          ...
          <div className="bg-[#FEE5E5] sm:bg-[#EDEFFB] p-6 rounded-lg">
            ...
            <div className="mt-6 flex justify-center space-x-8 text-center text-2xl text-[#1D3178]">
              ...
              <a
                ...
                aria-label="Send an email to Muqaddas Fatima"
              >
                <FaEnvelope />
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visit Muqaddas Fatima's Instagram"
              >
                <FaInstagram />
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visit Muqaddas Fatima's GitHub"
              >
                <FaGithub />
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visit Muqaddas Fatima's LinkedIn"
              >
                <FaLinkedin />
              </a>
            </div>
